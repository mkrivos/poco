...
// TraverseBase
//
TraverseBase::TraverseBase(DepthFunction depthDeterminer, UInt16 maxDepth):
...
//
ChildrenFirstTraverse::ChildrenFirstTraverse(DepthFunction depthDeterminer, UInt16 maxDepth):
...
//
SiblingsFirstTraverse::SiblingsFirstTraverse(DepthFunction depthDeterminer, UInt16 maxDepth)
	: TraverseBase(depthDeterminer, maxDepth)
{
